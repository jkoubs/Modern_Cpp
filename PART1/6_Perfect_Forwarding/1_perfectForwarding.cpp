...
template <typename T, typename T1> T create(T1 &&t1) {
...
Here we create a perfect factory

factory = fct or class that creates (constructs) objects

A factory which deals with lvalues and rvalues
and can take an arbitrary number of args
